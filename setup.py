...
data_files_spec = [
    ('share/jupyter/nbextensions/lineup_widget', 'lineup_widget/nbextension', '**'),
    ('share/jupyter/labextensions/lineup_widget', 'lineup_widget/labextension', '**'),
    ('share/jupyter/labextensions/lineup_widget', '.', 'install.json'),
