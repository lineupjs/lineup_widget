...
# -*- coding: utf-8 -*-
#
# lineup_widget documentation build configuration file
#
...
project = 'lineup_widget'
copyright = '2022, Samuel Gratzl'
...
_version_py = os.path.join(repo, 'lineup_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'lineup_widgetdoc'
...
latex_documents = [
    (master_doc, 'lineup_widget.tex', 'lineup_widget Documentation',
